	...
	<div class="container">
		<div class="bs-row">				<div class="col-md-9 col-lg-9">
				...
				<div class="element-wrap bmstu-pages-testimonials" id="testimonials-all">
					...
					<hr class="dashed" style="margin-top: 0px;">
					<div class="b-recall">
						<div class="recall-text">Продиагностировали и починили кнопку в Nexus 5 за 15 минут. До этого обращался к "официалам", объявили 11 к. и замену платы. Жалею, что сразу не обратился в BMSTU сервис. Хорошие ребята. И поболтать приятно)</div>
