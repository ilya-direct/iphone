...
INSERT INTO `category_article` VALUES (1,'Ремонт Samsung Galaxy S всего модельного ряда','<h2><span data-mce-mark=\"1\">Ремонт Samsung Galaxy S всего модельного ряда</span></h2><p>Компания Samsung имеет давнюю традицию производства качественных продуктов в сфер электроники. Так происходит, с их популярным смартфоном Galaxy S который обладает отличным качеством и богатым функционалом. Но и столь надежная техника выходит из строя. Стоит сказать, что ломаются смартфоны от самсунг в основном по вине их пользователей. Например, частым обращением к нам в сервис является просьба по замене разбитого экрана или трещины на сенсорном стекле. Так же часто приходится производить ремонт после попадания влаги в смартфон.</p><div class=\"collapsible collapse-xs collapsed\">'),(2,'Срочный ремонт телефонов не дорого с гарантией','<p><strong style=\"font-size: 16px;\">Срочный ремонт телефонов не дорого с гарантией</strong></p>\n	<p>В наше время сложно представить человека, который не пользуется мобильным телефона. Не удивительно, что ремонт телефонов одна из самых востребованных услуг.</p>\n	<p>Наши специалисты имеют огромный опыт ремонт мобильной техники, это говорит о том что ремонт телефонов в iQСервис будет осуществлен на профессиональном уровне. Мы готовы взяться за работу любой сложности, имеем опыт восстановления даже самых безнадежных устройств.</p><div class=\"collapsible collapse-xs collapsed\">\n		<div class=\"collapse-container\">\n			<p>Мы предоставляем бесплатную диагностику перед проведением работ, что позволит выявить точную причину поломки, после чего наши мастера произведут ремонт в кратчайшие сроки. </p>\n		</div>\n		<div class=\"collapse-buttons text-xs-center\">\n			<a href=\"#\" class=\"collapse-open\"><i class=\"icon-caret-down\"></i><span>Подробнее</span></a>\n			<a href=\"#\" class=\"collapse-close\"><i class=\"icon-caret-up\"></i><span>Скрыть</span></a>\n		</div>\n	</div>');
...
CREATE TABLE `device` (
  ...
  `lastalias` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_UNIQUE` (`name`),
...
-- Dump completed on 2015-09-05 17:35:51
